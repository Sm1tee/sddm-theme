...
[🚀 Автоустановка](#автоматическая-установка-рекомендуется) • [📥 Ручная установка](#ручная-установка) • [🎯 Особенности](#-особенности) • [🎨 Галерея](#-галерея-тем)
...
| � АMнимированные **MP4** фоны | 🌐 Мультиязычность | 🔧 Простая настройка |
...
> � **Совевт**: Используйте тестовый режим для быстрой проверки настроек темы перед применением.
...
├── � bMain.qml              # Главный файл темы
├── � moetadata.desktop      # Метаданные темы
└── 📄 qmldir                # QML модули
```
